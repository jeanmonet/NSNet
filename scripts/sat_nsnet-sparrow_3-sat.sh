...
python src/test_sat_solver.py SATSolving/3-sat/test_hard --solver Sparrow --max_flips 100 --n_process 8 --trial 3 --model NSNet
python src/test_sat_solver.py SATSolving/3-sat/test_hard --solver Sparrow --max_flips 100 --n_process 8 --trial 4 --model NSNet
python src/test_sat_solver.py SATSolving/3-sat/test_hard --solver Sparrow --max_flips 100 --n_process 8 --trial 5 --model NSNet
python src/test_sat_solver.py SATSolving/3-sat/test_hard --solver Sparrow --max_flips 100 --n_process 8 --trial 6 --model NSNet
python src/test_sat_solver.py SATSolving/3-sat/test_hard --solver Sparrow --max_flips 100 --n_process 8 --trial 7 --model NSNet
python src/test_sat_solver.py SATSolving/3-sat/test_hard --solver Sparrow --max_flips 100 --n_process 8 --trial 8 --model NSNet
